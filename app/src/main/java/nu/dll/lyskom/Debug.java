...
/**
 * Helper class to aid debug tracing. The println() and print() methods has no
 * effect unless the system property "lattekom.debug" is set to "true".
 */
public class Debug {
	/**
	 * <tt>true</tt> iff the "lattekom.debug" system property is non-null and
	 * equal to "true".
	 */
